    ...
    async def on_member_join(self, member):
        ...
        if welcome_channel:
            ...
            embed = Embed(
                ...
                description=f"Bienvenue, {member.mention}. Votre voyage commence ici, dans l'ombre de la Caverne... Essayez de survivre, les ombres vous souhaient un bon moment.",
